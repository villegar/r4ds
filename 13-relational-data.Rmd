...
```{r, echo = FALSE}
knitr::include_graphics("diagrams_pdf/es/relational-nycflights.pdf")
```
...
knitr::include_graphics("diagrams_pdf/es/join-setup.pdf")
```
```{r}
x <- tribble(
  ~key, ~val_x,
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-setup2.pdf")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-inner.pdf")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-outer.pdf")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-venn.pdf")
```
...
1. Una tabla tiene claves duplicadas. Esto es útil cuando quieres agregar información
 ...
 ```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-one-to-many.pdf")
 ```
...
1. Ambas tablas tienen claves duplicadas. Esto es usualmente un error debido a que
 ...
 ```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-many-to-many.pdf")
 ```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-semi.pdf")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-semi-many.pdf")
```

La operación inversa de `semi_join()` es `anti_join()`. `anti_join()` mantiene las filas que _no_ tienen coincidencias:

```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams_pdf/es/join-anti.pdf")
```
