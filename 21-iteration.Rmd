...
```{r, echo = FALSE}
knitr::include_graphics("diagrams_pdf/es/lists-map2.pdf")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams_pdf/es/lists-pmap-unnamed.pdf")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams_pdf/es/lists-pmap-named.pdf")
```
...
knitr::include_graphics("diagrams_pdf/es/lists-invoke.pdf")
```
