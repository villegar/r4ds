...
knitr::include_graphics("diagrams_pdf/es/visualization-stat-bar.pdf")
```
...
```{r, echo = FALSE, out.width = "100%"}
knitr::include_graphics("diagrams_pdf/es/visualization-grammar-1.pdf")
```
...
```{r, echo = FALSE, out.width = "100%"}
knitr::include_graphics("diagrams_pdf/es/visualization-grammar-2.pdf")
```
...
```{r, echo = FALSE, out.width = "100%"}
knitr::include_graphics("diagrams_pdf/es/visualization-grammar-3.pdf")
```
