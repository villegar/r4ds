...
knitr::include_graphics("diagrams_pdf/es/data-structures-overview.pdf")
```
...
knitr::include_graphics("diagrams_pdf/es/lists-structure.pdf")
```
...
knitr::include_graphics("diagrams_pdf/es/lists-subsetting.pdf")
```
